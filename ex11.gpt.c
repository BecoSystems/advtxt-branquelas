...
int main(void) {
   imprima("s", "Bem-vindo ao jogo de Halloween! Você está em uma mansão assombrada e há um assassino querendo te matar. Você terá que escolher uma resposta entre duas opções; se escolher errado, morrerá. Se escolher certo, você chegará ao fim!\n");
   imprima("s", "Você está na mansão, e para se defender, você tem duas opções: escolha (faca ou garfo):\n");
   _objeto = leia_literal();
   if((str_comp(_objeto,"faca"))) {
      imprima("s", "Você escolheu a faca. Você pega a faca para se defender e pode continuar o jogo.\n");
      imprima("s", "Você está a um passo de acabar. Vamos decidir o que irá fazer: você correr ou matar o assassino?\n");
      _verbo = leia_literal();
      if((str_comp(_verbo,"matar"))) {
         imprima("s", "Você escolheu matar. Você consegue matar o assassino. Parabéns, você ganhou!!!!!\n");
      } else {
         imprima("s", "Você escolheu correr e o assassino pegou você. Você morreu.\n");
      }

   } else {
      if((str_comp(_objeto,"garfo"))) {
         imprima("s", "Você escolheu o garfo. Tentou se defender e morreu. Tente novamente.\n");
      } else {
         imprima("s", "Opção inválida. Tente novamente.\n");
      }
